...
Clickhouse имеет два семейства фукнций для работы с JSON:
...
Неочевидные моменты и другие функции:
...
задачу по поиску расстояния между МКС (международной космической станции) и  ближайшего города. 
